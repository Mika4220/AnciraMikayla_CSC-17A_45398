...
/**  
   ...
   each player creates a account if they don't have one and if they do they can load their existing data
...
/**
   Double down
   If the user chooses to double down we take in the new amount wagered, deal one more card, and figure out if the user won
